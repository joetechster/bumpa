...
const styles = StyleSheet.create({
  ...
  cover: { width: 56, height: 84, borderRadius: radii.md, backgroundColor: colors.tan },
  // The cart row deliberately does NOT fall back to the title text like the
  // book cards do - the title already sits beside it, and rendering it twice
  // reads as a duplicate line item.
  coverFallback: {},
  lineInfo: { flex: 1, gap: spacing.xs },
  lineTitle: { ...type.heading, fontSize: 16, color: colors.text },
  lineControls: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  pressed: { opacity: 0.7 },
  checkoutText: { ...type.body, fontWeight: '700', color: colors.surface },
});
